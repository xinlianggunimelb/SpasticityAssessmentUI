...
{
    public class FFTAICommunicationM6TaskInterfaceOperationMode
    {
        // basic
        // basic : set work mode
    ...
    public class FFTAICommunicationM6TaskInterfaceWorkMode
    {
    ...
    public class FFTAICommunicationM6TaskInterfaceDebugWorkMode
    {
    ...
    public class FFTAICommunicationM6TaskInterfaceRelayWorkMode
    {
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWorkMode
    {
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkPassive1Command
    {
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkPassive2Command
    {
        public const int SET_HOME = 0x10;
        public const int STOP = 0x01;
        public const int SIT = 0x02;
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkPassive3Command
    {
        public const int SET_HOME = 0x10;
        public const int STOP = 0x01;
        public const int SIT = 0x02;
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkPassive4Command
    {
        public const int SET_HOME = 0x10;
        public const int STOP = 0x01;
        public const int SIT = 0x02;
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkActive1Command
    {
        public const int SET_HOME = 0x10;
        public const int STOP = 0x01;
        public const int WALK = 0x04;
    ...
    public class FFTAICommunicationM6TaskInterfaceMasterControlWalkActive2Command
    {
        public const int SET_HOME = 0x10;
        public const int STOP = 0x01;
        public const int WALK = 0x04;
