...
{
    public class FFTAICommunicationM6RobotInterface : FFTAICommunicationInterfaceBasic, IFFTAICommunicationInterfaceObserver
    {
        public int RequestReadFlagCalibration()
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagCalibration,
            ...
            functionResult = interfaceManager.Send(
                ...
                (uint)FFTAICommunicationFunctionType.M6_ROBOT_INTERFACE,
        ...
        public int RequestReadFlagServoOn()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagServoOn,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFlagEmergentStop()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagEmergentStop,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFlagFault()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagFault,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFlagInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagInformation,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFlagOutOfJointLimitInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagOutOfJointLimitInformation,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFlagOutOfEndEffectorLimitInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FlagOutOfEndEffectorLimitInformation,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadRedButtonValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.RedButtonValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadYellowButtonValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.YellowButtonValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadGreenButtonValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.GreenButtonValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadBlueButtonValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.BlueButtonValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadButtonSensorInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadButtonSensorInstalled()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorInstalled,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadButtonSensorAccessible()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorAccessible,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestSetButtonSensorCalibrate()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorCalibrate,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
        ...
        public int RequestReadLeftLegThighForceSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.LeftLegThighForceSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadLeftLegCalfForceSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.LeftLegCalfForceSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadRightLegThighForceSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.RightLegThighForceSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadRightLegCalfForceSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.RightLegCalfForceSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadForceSensorInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadForceSensorInstalled()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorInstalled,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadForceSensorAccessible()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorAccessible,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestSetForceSensorCalibrate()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorCalibrate,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadLeftLegFootPressureSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.LeftLegFootPressureSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadRightLegFootPressureSensorValue()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.RightLegFootPressureSensorValue,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadFootPressureSensorInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadFootPressureSensorInstalled()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureInstalled,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadFootPressureSensorAccessible()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureAccessible,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestSetFootPressureSensorCalibrate()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureCalibrate,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadDriverInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.DriverInformation,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadDriverInstalled()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.DriverInstalled,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadDriverAccessible()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.DriverAccessible,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestReadModeOfOperation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ModeOfOperation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadControlWord()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.ControlWord,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadStatusWord()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.StatusWord,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteFaultClear()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.FaultClear,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteMotorEnable()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.MotorEnable,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteMotorDisable()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.MotorDisable,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadMotorCurrent()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.MotorCurrent,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadMotorInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.MotorInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointTorque()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointTorque,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorTorque()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorTorque,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorInformation,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetJointLimitKinetic()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointLimitKinetic,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
        ...
        public int RequestGetJointLimitAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointLimitAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetJointLimitVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointLimitVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetJointLimitPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointLimitPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetEndEffectorLimitKinetic()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorLimitKinetic,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetEndEffectorLimitAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorLimitAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetEndEffectorLimitVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorLimitVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestGetEndEffectorLimitPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorLimitPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.GET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
            ...
            uint  verticalJointLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsJointLimitKinetic,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalJointLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsJointLimitAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalJointLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsJointLimitVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalJointLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsJointLimitPosition,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalEndEffectorLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsEndEffectorLimitKinetic,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalEndEffectorLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsEndEffectorLimitAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalEndEffectorLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsEndEffectorLimitVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
            ...
            uint  verticalEndEffectorLimitMaxSetFlag)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.CurrentValueAsEndEffectorLimitPosition,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
        ...
        public int RequestWriteHomeControlZeroHomePosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.HomeControlZeroHomePosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointTorqueControlTorque(
            float torque1, float torque2, float torque3, float torque4,float torque5,float torque6)
        {
            int functionResult;

            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointTorqueControlTorque,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
                                    ...
                                    BitConverter.ToUInt32(BitConverter.GetBytes(torque5), 0),
                                    BitConverter.ToUInt32(BitConverter.GetBytes(torque6), 0)});
        ...
        public int RequestReadJointVelocityControlAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointVelocityControlAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteJointVelocityControlAcceleration(
            float acceleration1, float acceleration2, float acceleration3, float acceleration4, float acceleration5, float acceleration6)
        {
            int functionResult;
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                ...
                                new uint [] {
                                    ...
                                    BitConverter.ToUInt32(BitConverter.GetBytes(acceleration5), 0),
                                    BitConverter.ToUInt32(BitConverter.GetBytes(acceleration6), 0)});
        ...
        public int RequestReadJointVelocityControlDeceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointVelocityControlDeceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteJointVelocityControlDeceleration(
            float deceleration1, float deceleration2, float deceleration3, float deceleration4,float deceleration5,float deceleration6)
        {
            int functionResult;
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                ...
                                new uint [] {
                                    ...
                                    BitConverter.ToUInt32(BitConverter.GetBytes(deceleration5), 0),
                                    BitConverter.ToUInt32(BitConverter.GetBytes(deceleration6), 0)});
        ...
        public int RequestReadJointVelocityControlVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointVelocityControlVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteJointVelocityControlVelocity(
            float velocity1, float velocity2, float velocity3, float velocity4, float velocity5, float velocity6)
        {
            int functionResult;
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                ...
                                new uint [] {
                                    ...
                                    BitConverter.ToUInt32(BitConverter.GetBytes(velocity5), 0),
                                    BitConverter.ToUInt32(BitConverter.GetBytes(velocity6), 0)});
        ...
        public int RequestReadJointPositionControlAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointPositionControlAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointPositionControlDeceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointPositionControlDeceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointPositionControlVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointPositionControlVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadJointPositionControlPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.JointPositionControlPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestWriteJointPositionControlPosition(
            float position1, float position2, float position3, float position4, float position5,float position6)
        {
            int functionResult;
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                ...
                                new uint [] {
                                    ...
                                    BitConverter.ToUInt32(BitConverter.GetBytes(position5), 0),
                                    BitConverter.ToUInt32(BitConverter.GetBytes(position6), 0)});
            ...
            float torque1, float torque2, float torque3, float torque4, float torque5, float torque6)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorTorqueControlTorque,
                                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                                (uint)FFTAICommunicationReadWriteOperation.WRITE,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] {
        ...
        public int RequestReadEndEffectorVelocityControlAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorVelocityControlAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorVelocityControlDeceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorVelocityControlDeceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorVelocityControlVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorVelocityControlVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorPositionControlAcceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorPositionControlAcceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorPositionControlDeceleration()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorPositionControlDeceleration,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorPositionControlVelocity()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorPositionControlVelocity,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int RequestReadEndEffectorPositionControlPosition()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorPositionControlPosition,
                                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                                (uint)FFTAICommunicationReadWriteOperation.READ,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { });
        ...
        public int ModelUpdateHandle(FFTAICommunicationInterfaceModelBasic model)
        {
            ...
            {
                case FFTAICommunicationM6RobotInterfaceOperationMode.FlagInformation:
                    {
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.FlagOutOfJointLimitInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.FlagOutOfEndEffectorLimitInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.ButtonSensorAccessible:
                    {
                        switch (readWriteOperation)
                        {
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.ForceSensorAccessible:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.FootPressureAccessible:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.DriverAccessible:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                            case FFTAICommunicationReadWriteOperation.READ:
                                ...
                                StatusRobot.Driver5.Accessible = (uint)BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[4]), 0);
                                StatusRobot.Driver6.Accessible = (uint)BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[5]), 0);
                                break;
                            default:
                                break;
                        }
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.JointInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
                            case FFTAICommunicationReadWriteOperation.READ:
                                ...
                                StatusRobot.KineticDataJoint5 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[4]), 0);
                                StatusRobot.KineticDataJoint6 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[5]), 0);
                                StatusRobot.VelocityDataJoint1 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[6]), 0);
                                StatusRobot.VelocityDataJoint2 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[7]), 0);
                                StatusRobot.VelocityDataJoint3 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[8]), 0);
                                StatusRobot.VelocityDataJoint4 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[9]), 0);
                                StatusRobot.VelocityDataJoint5 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[10]), 0);
                                StatusRobot.VelocityDataJoint6 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[11]), 0);
                                StatusRobot.PositionDataJoint1 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[12]), 0);
                                StatusRobot.PositionDataJoint2 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[13]), 0);
                                StatusRobot.PositionDataJoint3 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[14]), 0);
                                StatusRobot.PositionDataJoint4 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[15]), 0);
                                StatusRobot.PositionDataJoint5 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[16]), 0);
                                StatusRobot.PositionDataJoint6 = BitConverter.ToSingle(BitConverter.GetBytes(model.DataSectionModel.ResponseModel.Parameter[17]), 0);
                                ...
                                //StatusRobot.PositionDataJoint5 = StatusRobot.PositionDataJoint5 < 0 ? 0 : StatusRobot.PositionDataJoint5;
                                //StatusRobot.PositionDataJoint6 = StatusRobot.PositionDataJoint6 < 0 ? 0 : StatusRobot.PositionDataJoint6;
                                break;
                            case FFTAICommunicationReadWriteOperation.SET:
                            case FFTAICommunicationReadWriteOperation.WRITE:
                                break;
                ...
                case FFTAICommunicationM6RobotInterfaceOperationMode.EndEffectorInformation:
                    {
                        switch (readWriteOperation)
                        {
                            case FFTAICommunicationReadWriteOperation.GET:
        ...
        {
            return FFTAICommunicationFunctionType.M6_ROBOT_INTERFACE;
        }
    }
}
