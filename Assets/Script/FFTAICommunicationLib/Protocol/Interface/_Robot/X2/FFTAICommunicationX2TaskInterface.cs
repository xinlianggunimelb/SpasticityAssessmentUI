...
{
    public class FFTAICommunicationX2TaskInterface : FFTAICommunicationInterfaceBasic, IFFTAICommunicationInterfaceObserver
    {
        public int RequestSetWorkMode(int workMode)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.BASIC_WORK_MODE,
            ...
            functionResult = interfaceManager.Send(
                                ...
                                (uint)FFTAICommunicationFunctionType.X2_TASK_INTERFACE,
        ...
        public int RequestReadFlagTaskInProcess()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.BASIC_FLAG_TASK_IN_PROCESS,
        ...
        public int RequestReadFlagInformation()
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.BASIC_FLAG_INFORMATION,
                (uint)FFTAICommunicationNumberOfParameter.ZERO,
                (uint)FFTAICommunicationReadWriteOperation.READ,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { });
        ...
        public int RequestSetDebugWorkMode(int workMode)
        {
            ...
            // build request model
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.DEBUG_WORK_MODE,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { (uint)workMode });
        ...
        public int RequestSetRelayWorkMode(int workMode)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.RELAY_WORK_MODE,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { (uint)workMode });
        ...
        public int RequestSetMasterControlWorkMode(int workMode)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WORK_MODE,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { (uint)workMode });
        ...
        public int RequestSetMasterControlWalkPassive1Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_PASSIVE_1_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
        ...
        public int RequestSetMasterControlWalkPassive2Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_PASSIVE_2_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
        ...
        public int RequestSetMasterControlWalkAssist1Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_ASSIST_1_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
        ...
        public int RequestSetMasterControlWalkAssist2Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_ASSIST_2_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
        ...
        public int RequestSetMasterControlWalkActive1Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_ACTIVE_1_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
        ...
        public int RequestSetMasterControlWalkActive2Command(uint  command)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.MASTER_CONTROL_WALK_ACTIVE_2_COMMAND,
                                (uint)FFTAICommunicationNumberOfParameter.ONE,
                                (uint)FFTAICommunicationReadWriteOperation.SET,
                                (uint)FFTAICommunicationFillingParameter.PATCH,
                                new uint [] { command });
            ...
            float rightLegKneeJointKinetic)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_KINETIC_CONTROL_KINETIC,
            ...
            float rightLegKneeJointAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_VELOCITY_CONTROL_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeJointVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_VELOCITY_CONTROL_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeJointAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_POSITION_CONTROL_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeJointVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_POSITION_CONTROL_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeJointPosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_JOINT_POSITION_CONTROL_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float endEffectorY2Kinetic)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_KINETIC_CONTROL_KINETIC,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
        ...
        /// <param name="endEffectorX2Acceleration"></param>
            ...
            float endEffectorY2Acceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_VELOCITY_CONTROL_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
        ...
        /// <param name="endEffectorX2Velocity"></param>
            ...
            float endEffectorY2Velocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_VELOCITY_CONTROL_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float endEffectorY2Acceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_POSITION_CONTROL_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float endEffectorY2Velocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_POSITION_CONTROL_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
        ...
        /// <param name="endEffectorX2Position"></param>
            ...
            float endEffectorY2Position)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_END_EFFECTOR_POSITION_CONTROL_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_MOVE_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_MOVE_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_MOVE_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeKinetic)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_ASSIST_MOVE_KINETIC,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_ASSIST_MOVE_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeKinetic)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_ACTIVE_MOVE_KINETIC,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeOriginPosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_TRANSPARENT_CONTROL_MOVE_ORIGIN_POINT,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeM)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_TRANSPARENT_CONTROL_MOVE_M,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeB)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_TRANSPARENT_CONTROL_MOVE_B,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeK)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_TRANSPARENT_CONTROL_MOVE_K,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] { 
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_SIT_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_SIT_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_SIT_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_SIT_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_SIT_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_STAND_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_STAND_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_STAND_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_STAND_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_STAND_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASIT_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASIT_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASIT_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASIT_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASIT_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASTAND_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASTAND_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASTAND_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASTAND_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_BASTAND_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLS_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLS_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLS_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLS_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLS_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLS_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLS_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLS_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLS_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLS_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLF_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLF_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLF_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLF_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLF_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLF_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLF_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLF_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOSTAND_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOSTAND_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOSTAND_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOSTAND_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOSTAND_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeAcceleration)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTOSTAND_ACCELERATION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneeVelocity)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTOSTAND_VELOCITY,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
            ...
            float rightLegKneePosition)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTOSTAND_POSITION,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float rightLegKneePositionOffset)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTOSTAND_POSITION_OFFSET,
                (uint)FFTAICommunicationNumberOfParameter.FOUR,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTOSTAND_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLSTORLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLSTOLLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_LLFTORLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_RLFTOLLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_WALKWITHLLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
           ...
           float runSpeedTimes)
        {
            ...
            functionResult = Model.DataSectionModel.RequestModel.Update(
                (uint)FFTAICommunicationX2TaskInterfaceOperationMode.SUBTASK_BASIC_PASSIVE_WALKWITHRLF_RUN_SPEED_TIMES,
                (uint)FFTAICommunicationNumberOfParameter.ONE,
                (uint)FFTAICommunicationReadWriteOperation.SET,
                (uint)FFTAICommunicationFillingParameter.PATCH,
                new uint [] {
        ...
        public int ModelUpdateHandle(FFTAICommunicationInterfaceModelBasic model)
        {
            ...
            {
                case FFTAICommunicationX2TaskInterfaceOperationMode.BASIC_FLAG_TASK_IN_PROCESS:
                    {
        ...
        {
            return FFTAICommunicationFunctionType.X2_TASK_INTERFACE;
        }
